...
import com.aw.api.os.apirest.controle.ControllerMarca;
import com.aw.api.os.apirest.controle.ControllerVeiculo;
...
public class ServiceVeiculo {
	...
	public String inserirVeiculo(Veiculo veiculo) throws Exception {
		...
		if(com.aw.api.os.apirest.controle.ControllerVeiculo.addVeiculo(veiculo) == 1) {
	...
	//SERVI�O PESQUISA VEICULO POR ID
