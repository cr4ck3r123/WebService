...
import com.aw.api.os.apirest.controle.ControllerServico;
import com.aw.api.os.apirest.modelo.Cliente;
import com.aw.api.os.apirest.modelo.Servico;
...
//ADICIONA SERVICO  
	...
	// SERVI�O PESQUISA PESSOA E RETORNOA UM JSON
			@GET
			@Path("pesquisar/{id}/")
